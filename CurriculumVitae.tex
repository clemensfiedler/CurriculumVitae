...
\justify{
Curious and problem-oriented with an extensive background in \textbf{Economics} and \textbf{Industrial Organization}. Highly skilled in \textbf{programming} and  \textbf{simulations} in \textbf{Python} and \textbf{R}, an active \textbf{teacher of programming} at the Bachelor's- and Master's level. Understanding of both \textbf{Game Theoretical} and \textbf{Econometric} models. A versatile, motivated, and experienced \textbf{leader}, \textbf{coordinator}, and \textbf{team worker} willing to take the initiative and engage problems head-on.}
